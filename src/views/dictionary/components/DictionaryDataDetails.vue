  ...
  <el-dialog
    ...
    <el-form :model='addForm' :rules='addFormRules' ref='addFormRef' label-width='150px'>
      ...
      <el-form-item label="字典类型">
        <el-select v-model="addForm.typeId" placeholder="请选择字典类型" clearable>
...
<script>
import { update, create, getById } from 'api/dictionary'
import { listByPage } from 'api/dictionarytype'
import {ref} from 'vue'
